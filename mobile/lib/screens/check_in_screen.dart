...
class _CheckInScreenState extends State<CheckInScreen> {
  ...
  void initState() {
    super.initState();
    _selectedShiftId = widget.defaultShiftId;
  ...
  Future<void> _initGPS() async {
    try {
      ...
      // Advanced Anti-Cheat: Detect Fake GPS/Mock Location
      // On Android, Geolocator provides the isMocked flag
  ...
  /// Calculate distance to offices and select the nearest one
  ...
  /// Take picture from the circular front-camera preview
  ...
  Future<void> _submitCheckIn() async {
    if (_capturedPhoto == null || _currentPosition == null || _selectedShiftId == null) return;
    ...
    try {
      ...
      if (result['success'] == true) {
        ...
        // Success dialog
        await _showSuccessDialog(result['message'] ?? 'Absen masuk berhasil!');
        if (mounted) {
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // 3. Shift Selection Dropdown Card
                  _buildShiftDropdownCard(),
  ...
  Widget _buildShiftDropdownCard() {
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<int>(
              ...
              isExpanded: true,
              hint: const Text('Pilih Shift Kerja Anda'),
              dropdownColor: const Color(0xFF151D30),
              decoration: const InputDecoration(
                contentPadding: EdgeInsets.symmetric(horizontal: 12, vertical: 8),
              ),
              items: widget.shifts.map<DropdownMenuItem<int>>((dynamic s) {
