...
<div class="max-w-2xl mx-auto space-y-5 animate-fadeSlideIn">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:0.25rem;">
        <div>
            <h2 style="font-size:1.1rem;font-weight:800;color:var(--t1);letter-spacing:-0.01em;">Tambah Lokasi Kantor</h2>
            <p style="font-size:0.78rem;color:var(--t4);margin-top:0.25rem;">Definisikan area geofencing baru untuk validasi absensi GPS karyawan</p>
        </div>
    ...
    <div class="card">
        <form method="POST" action="{{ route('master.locations.store') }}" style="display:flex;flex-direction:column;gap:1.25rem;">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control"
                    placeholder="Contoh: Kantor Pusat Jakarta, Cabang Bandung"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="any" name="latitude" id="latitude" class="form-control"
                        ...
                        placeholder="-6.2088" value="{{ old('latitude') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="any" name="longitude" id="longitude" class="form-control"
                        style="font-family:'JetBrains Mono',monospace;"
                        placeholder="106.8456" value="{{ old('longitude') }}" required>
                ...
                <div class="form-group">
                    ...
                    <div style="display:flex;align-items:center;gap:0.4rem;">
                        <input type="number" name="radius_meters" id="radius_meters" class="form-control"
                            ...
                            value="{{ old('radius_meters', 100) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea name="address" id="address" rows="3" class="form-control"
                    placeholder="Tuliskan alamat fisik lengkap kantor...">{{ old('address') }}</textarea>
            ...
            <div style="display:flex;align-items:flex-start;gap:0.75rem;padding:0.9rem 1rem;background:var(--em-ghost);border:1px solid var(--em-border);border-radius:12px;font-size:0.76rem;color:var(--t3);">
                ...
                <div>
                    ...
                    Gunakan tombol deteksi otomatis untuk memposisikan peta langsung pada lokasi Anda, atau klik di mana saja pada peta di atas untuk memposisikan marker secara manual.
                </div>
            </div>
